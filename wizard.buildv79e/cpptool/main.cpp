...
class c_AndroidTabletSupport : public Object,public virtual c_Command{
	public:
	c_AndroidTabletSupport();
	void p_Run(c_App*);
	c_AndroidTabletSupport* m_new();
	void mark();
	String debug();
};
String dbg_type(c_AndroidTabletSupport**p){return "AndroidTabletSupport";}
...
class c_R177 : public c_ClassInfo{
	public:
	c_R177();
	c_R177* m_new();
	Object* p_NewInstance();
...
class c_R173 : public c_MethodInfo{
	public:
	c_R173();
	c_R173* m_new();
	void mark();
...
class c_R174 : public c_FunctionInfo{
	public:
	c_R174();
	c_R174* m_new();
	void mark();
...
class c_R178 : public c_FieldInfo{
	public:
	c_R178();
	c_R178* m_new();
	void mark();
...
class c_R179 : public c_FunctionInfo{
	public:
	c_R179();
	c_R179* m_new();
	void mark();
...
class c_R181 : public c_FunctionInfo{
	public:
	c_R181();
	c_R181* m_new();
	void mark();
...
String dbg_type(c_R181**p){return "R181";}
...
String c_File::p_data(){
	...
	c_File *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/file.monkey<178>");
	if(!m_loaded && bb_helperos_FileExists(m_path)){
		DBG_BLOCK();
		DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/file.monkey<179>");
		m_loaded=true;
	...
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/file.monkey<183>");
	return m__data;
}
void c_File::p_data2(String t_newData){
	...
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/file.monkey<187>");
	m_dirty=true;
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/file.monkey<188>");
	m__data=t_newData;
}
...
c_AndroidIcons::c_AndroidIcons(){
	m_app=0;
	String t_[]={String(L"low",3),String(L"medium",6),String(L"high",4),String(L"extra-high",10),String(L"super-high",10)};
	m_VALID_TYPES=Array<String >(t_,5);
}
...
String c_AndroidIcons::p_GetFilename(){
	...
	c_AndroidIcons *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<83>");
	if(m_app->p_GetAdditionArguments().Length()<2){
		DBG_BLOCK();
		return String();
	}
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<84>");
		...
		if(t_1==String(L"medium",6)){
			...
			if(t_1==String(L"high",4)){
				...
				if(t_1==String(L"extra-high",10)){
					...
					DBG_BLOCK();
					DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<74>");
					if(t_1==String(L"super-high",10)){
						DBG_BLOCK();
						...
						return String(L"xxh",3);
					}else{
						DBG_BLOCK();
						DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<77>");
						m_app->p_LogError(String(L"No short version of the given type defined",42));
						DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<78>");
						return String();
					}
				}
			}
...
c_File* c_AndroidIcons::p_GetFile(){
	...
	c_AndroidIcons *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidicons.monkey<88>");
...
c_AndroidTabletSupport::c_AndroidTabletSupport(){
}
void c_AndroidTabletSupport::p_Run(c_App* t_app){
	DBG_ENTER("AndroidTabletSupport.Run")
	c_AndroidTabletSupport *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_app,"app")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<14>");
	c_File* t_manifest=c_Android::m_GetManifest();
	DBG_LOCAL(t_manifest,"manifest")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<16>");
	Array<int > t_sdkLines=t_manifest->p_FindLines(String(L"uses-sdk",8));
	DBG_LOCAL(t_sdkLines,"sdkLines")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<18>");
	if(t_sdkLines.Length()!=1){
		DBG_BLOCK();
		DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<19>");
		t_app->p_LogError(String(L"Found zero or more than one 'uses-sdk' property",47));
	}
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<22>");
	String t_line=String(L"<uses-sdk android:minSdkVersion=\"11\" android:targetSdkVersion=\"14\" />",69);
	DBG_LOCAL(t_line,"line")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<23>");
	t_manifest->p_ReplaceLine(t_sdkLines.At(0),t_line);
}
c_AndroidTabletSupport* c_AndroidTabletSupport::m_new(){
	DBG_ENTER("AndroidTabletSupport.new")
	c_AndroidTabletSupport *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/androidtabletsupport.monkey<12>");
	return this;
}
void c_AndroidTabletSupport::mark(){
	Object::mark();
}
String c_AndroidTabletSupport::debug(){
	String t="(AndroidTabletSupport)\n";
	return t;
}
c_List2::c_List2(){
...
void c_IosChartboost::p_CopyFramework(c_App* t_app){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_app,"app")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<28>");
	c_Dir* t_src=t_app->p_SourceDir(String(L"Chartboost.framework",20));
	DBG_LOCAL(t_src,"src")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<29>");
	...
	t_src->p_CopyTo3(t_dst,true,true,true);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<35>");
	c_Dir* t_target=t_app->p_TargetDir(String(L"Chartboost.framework/Versions",29));
	DBG_LOCAL(t_target,"target")
	...
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<38>");
	...
	c_Ios::m_GetProject()->p_InsertAfter(String(L"\t\t\t\tFRAMEWORK_SEARCH_PATHS = (",30),String(L"\t\t\t\t\t\"\\\"$(PROJECT_DIR)/Chartboost.framework\\\"\",",47));
}
void c_IosChartboost::p_Run(c_App* t_app){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_app,"app")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<15>");
	c_Ios::m_AddFramework(String(L"AdSupport.framework",19),true);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<16>");
	c_Ios::m_AddFramework(String(L"StoreKit.framework",18),false);
	...
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/ioschartboost.monkey<22>");
	t_app->p_LogInfo(String(L"Chartboost installed!",21));
}
...
void c_IosVungle::p_AddLibZ(){
	...
	String t_firstId=c_Ios::m_GenerateUniqueId();
	DBG_LOCAL(t_firstId,"firstId")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<64>");
	String t_secondId=c_Ios::m_GenerateUniqueId();
	DBG_LOCAL(t_secondId,"secondId")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<66>");
	String t_name=String(L"libz.dylib",10);
	DBG_LOCAL(t_name,"name")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<68>");
	...
	DBG_LOCAL(t_patchStr,"patchStr")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<78>");
	c_Ios::m_AddPbxFileReference(t_name,t_patchStr);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<80>");
	c_Ios::m_AddPbxFrameworkBuildPhase(t_name,t_firstId);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<82>");
	c_Ios::m_AddPbxGroupChild(String(L"Frameworks",10),t_name,t_secondId);
}
void c_IosVungle::p_AddLibSqlite(){
	DBG_ENTER("IosVungle.AddLibSqlite")
	c_IosVungle *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<86>");
	String t_firstId=c_Ios::m_GenerateUniqueId();
	DBG_LOCAL(t_firstId,"firstId")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<87>");
	String t_secondId=c_Ios::m_GenerateUniqueId();
	DBG_LOCAL(t_secondId,"secondId")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<89>");
	String t_name=String(L"libsqlite3.dylib",16);
	DBG_LOCAL(t_name,"name")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<91>");
	c_Ios::m_AddPbxBuildFile(t_name,t_firstId,t_secondId,false,String());
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<100>");
	String t_patchStr=String(L"\t\t",2)+t_secondId+String(L" ",1)+String(L"/* ",3)+t_name+String(L" */ = ",6)+String(L"{isa = PBXFileReference; ",25)+String(L"lastKnownFileType = \"compiled.mach-o.dylib\"; ",45)+String(L"name = ",7)+t_name+String(L"; ",2)+String(L"path = usr/lib/libsqlite3.dylib; ",33)+String(L"sourceTree = SDKROOT; };",24);
	DBG_LOCAL(t_patchStr,"patchStr")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<101>");
	c_Ios::m_AddPbxFileReference(t_name,t_patchStr);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<103>");
	c_Ios::m_AddPbxFrameworkBuildPhase(t_name,t_firstId);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<105>");
	c_Ios::m_AddPbxGroupChild(String(L"Frameworks",10),t_name,t_secondId);
}
void c_IosVungle::p_AddOrientationPortrait(){
	...
	c_IosVungle *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<47>");
	c_File* t_file=c_Ios::m_GetPlist();
	DBG_LOCAL(t_file,"file")
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<59>");
	t_file->p_InsertBefore(String(L"</dict>",7),String(L"\t<key>UISupportedInterfaceOrientations</key>\n\t<array>\n\t\t<string>UIInterfaceOrientationPortrait</string>\n\t\t<string>UIInterfaceOrientationPortraitUpsideDown</string>\n\t</array>\n\t<key>UISupportedInterfaceOrientations~ipad</key>\n\t<array>\n\t\t<string>UIInterfaceOrientationPortrait</string>\n\t\t<string>UIInterfaceOrientationPortraitUpsideDown</string>\n\t</array>",352));
}
void c_IosVungle::p_CopyFramework(c_App* t_app){
	...
	c_Dir* t_src=t_app->p_SourceDir(String(L"VungleSDK.embeddedframework",27));
	DBG_LOCAL(t_src,"src")
	...
	c_Dir* t_dst=t_app->p_TargetDir(String(L"VungleSDK.embeddedframework",27));
	DBG_LOCAL(t_dst,"dst")
	...
	c_Dir* t_target=t_app->p_TargetDir(String(L"VungleSDK.embeddedframework/VungleSDK.framework/Versions",56));
	DBG_LOCAL(t_target,"target")
	...
	p_AddLibZ();
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<34>");
	p_AddLibSqlite();
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<36>");
	c_Ios::m_AddFrameworkFromPath(String(L"VungleSDK.embeddedframework",27),false);
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<40>");
	c_Ios::m_GetProject()->p_InsertAfter(String(L"\t\t\t\tFRAMEWORK_SEARCH_PATHS = (",30),String(L"\t\t\t\t\t\"\\\"$(PROJECT_DIR)/VungleSDK.embeddedframework\\\"\",",54));
	DBG_INFO("/Users/jochenheizmann/Dropbox/Monkey/modules_ext/fairlight/vendor/monkey-wizard/wizard/commands/iosvungle.monkey<43>");
...
void c_IosVungle::p_Run(c_App* t_app){
	...
	t_app->p_LogInfo(String(L"New Vungle installed!",21));
}
...
c_R106* c_R106::m_new(){
	c_ClassInfo* t_[]={bb_reflection__unknownClass};
	c_ClassInfo::m_new(String(L"wizard.commands.androidtabletsupport.AndroidTabletSupport",57),0,bb_reflection__classes.At(0),Array<c_ClassInfo* >(t_,1));
	return this;
}
Object* c_R106::p_NewInstance(){
	return ((new c_AndroidTabletSupport)->m_new());
}
int c_R106::p_Init(){
	gc_assign(m__ctors,Array<c_FunctionInfo* >(1));
...
int c_R170::p_Init(){
	...
	gc_assign(m__methods.At(2),((new c_R173)->m_new()));
	gc_assign(m__ctors,Array<c_FunctionInfo* >(1));
	gc_assign(m__ctors.At(0),((new c_R174)->m_new()));
	p_InitR();
	return 0;
}
void c_R170::mark(){
...
Object* c_R175::p_NewInstance(){
	return ((new c_SamsungPayment)->m_new());
}
int c_R175::p_Init(){
	gc_assign(m__ctors,Array<c_FunctionInfo* >(1));
	gc_assign(m__ctors.At(0),((new c_R176)->m_new()));
	p_InitR();
	return 0;
}
void c_R175::mark(){
...
Object* c_R177::p_NewInstance(){
	return ((new c_ArrayObject)->m_new2());
}
int c_R177::p_Init(){
	gc_assign(m__fields,Array<c_FieldInfo* >(1));
	gc_assign(m__fields.At(0),((new c_R178)->m_new()));
	gc_assign(m__methods,Array<c_MethodInfo* >(1));
	gc_assign(m__methods.At(0),((new c_R180)->m_new()));
	gc_assign(m__ctors,Array<c_FunctionInfo* >(2));
	gc_assign(m__ctors.At(0),((new c_R179)->m_new()));
	gc_assign(m__ctors.At(1),((new c_R181)->m_new()));
	p_InitR();
	return 0;
}
void c_R177::mark(){
...
int bb_reflection___init(){
	...
	gc_assign(bb_reflection__classes.At(35),((new c_R175)->m_new()));
	gc_assign(bb_reflection__classes.At(36),((new c_R177)->m_new()));
...
c_R94* c_R94::m_new(){
	c_MethodInfo::m_new(String(L"CheckArgs",9),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R94::mark(){
	c_MethodInfo::mark();
...
c_R95* c_R95::m_new(){
	c_MethodInfo::m_new(String(L"IsValidType",11),2,bb_reflection__boolClass,Array<c_ClassInfo* >());
	return this;
}
void c_R95::mark(){
	c_MethodInfo::mark();
...
c_R96* c_R96::m_new(){
	c_MethodInfo::m_new(String(L"IsValidFilename",15),2,bb_reflection__boolClass,Array<c_ClassInfo* >());
	return this;
}
void c_R96::mark(){
	c_MethodInfo::mark();
...
c_R97* c_R97::m_new(){
	c_MethodInfo::m_new(String(L"GetType",7),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R97::mark(){
	c_MethodInfo::mark();
...
c_R98* c_R98::m_new(){
	c_MethodInfo::m_new(String(L"GetShortType",12),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R98::mark(){
	c_MethodInfo::mark();
...
c_R99* c_R99::m_new(){
	c_MethodInfo::m_new(String(L"GetFilename",11),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R99::mark(){
	c_MethodInfo::mark();
...
c_R104* c_R104::m_new(){
	c_MethodInfo::m_new(String(L"PatchPermissions",16),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R104::mark(){
	c_MethodInfo::mark();
...
c_R115* c_R115::m_new(){
	c_FunctionInfo::m_new(String(L"GetRegions",10),2,bb_reflection__classes.At(36),Array<c_ClassInfo* >());
	return this;
}
void c_R115::mark(){
	c_FunctionInfo::mark();
...
c_R122* c_R122::m_new(){
	c_MethodInfo::m_new(String(L"RemoveOldSettings",17),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R122::mark(){
	c_MethodInfo::mark();
...
c_R123* c_R123::m_new(){
	c_ClassInfo* t_[]={bb_reflection__boolClass};
	c_MethodInfo::m_new(String(L"AddSettings",11),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R123::mark(){
	c_MethodInfo::mark();
...
c_R124* c_R124::m_new(){
	c_MethodInfo::m_new(String(L"IsEnabled",9),2,bb_reflection__boolClass,Array<c_ClassInfo* >());
	return this;
}
void c_R124::mark(){
	c_MethodInfo::mark();
...
c_R136* c_R136::m_new(){
	c_MethodInfo::m_new(String(L"AddSettings",11),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R136::mark(){
	c_MethodInfo::mark();
...
c_R140* c_R140::m_new(){
	c_ClassInfo* t_[]={bb_reflection__boolClass};
	c_MethodInfo::m_new(String(L"AddPrerenderedFlag",18),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R140::mark(){
	c_MethodInfo::mark();
...
c_R141* c_R141::m_new(){
	c_MethodInfo::m_new(String(L"RemovePrerenderedFlag",21),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R141::mark(){
	c_MethodInfo::mark();
...
c_R142* c_R142::m_new(){
	c_MethodInfo::m_new(String(L"RemoveIcons",11),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R142::mark(){
	c_MethodInfo::mark();
...
c_R143* c_R143::m_new(){
	...
	c_MethodInfo::m_new(String(L"ParseRowsAndRemoveFiles",23),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R143::mark(){
	c_MethodInfo::mark();
...
c_R144* c_R144::m_new(){
	c_ClassInfo* t_[]={bb_reflection__stringClass};
	c_MethodInfo::m_new(String(L"RemoveKeyWithValues",19),2,bb_reflection__classes.At(36),Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R144::mark(){
	c_MethodInfo::mark();
...
c_R145* c_R145::m_new(){
	c_ClassInfo* t_[]={bb_reflection__stringClass};
	c_MethodInfo::m_new(String(L"ExtractFileName",15),2,bb_reflection__stringClass,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R145::mark(){
	c_MethodInfo::mark();
...
c_R146* c_R146::m_new(){
	c_ClassInfo* t_[]={bb_reflection__stringClass};
	c_MethodInfo::m_new(String(L"RemoveFileDefinition",20),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R146::mark(){
	c_MethodInfo::mark();
...
c_R147* c_R147::m_new(){
	c_ClassInfo* t_[]={bb_reflection__stringClass};
	c_MethodInfo::m_new(String(L"RemoveFilePhysical",18),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R147::mark(){
	c_MethodInfo::mark();
...
c_R148* c_R148::m_new(){
	c_MethodInfo::m_new(String(L"IsPrerendered",13),2,bb_reflection__boolClass,Array<c_ClassInfo* >());
	return this;
}
void c_R148::mark(){
	c_MethodInfo::mark();
...
c_R151* c_R151::m_new(){
	c_MethodInfo::m_new(String(L"AddOrientationBoth",18),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R151::mark(){
	c_MethodInfo::mark();
...
c_R152* c_R152::m_new(){
	c_MethodInfo::m_new(String(L"AddOrientationLandscape",23),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R152::mark(){
	c_MethodInfo::mark();
...
c_R153* c_R153::m_new(){
	c_MethodInfo::m_new(String(L"AddOrientationPortrait",22),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R153::mark(){
	c_MethodInfo::mark();
...
c_R154* c_R154::m_new(){
	c_MethodInfo::m_new(String(L"GetOrientation",14),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R154::mark(){
	c_MethodInfo::mark();
...
c_R156* c_R156::m_new(){
	c_ClassInfo* t_[]={bb_reflection__intClass};
	c_MethodInfo::m_new(String(L"RemoveKeyWithValues",19),2,0,Array<c_ClassInfo* >(t_,1));
	return this;
}
void c_R156::mark(){
	c_MethodInfo::mark();
...
c_R157* c_R157::m_new(){
	c_MethodInfo::m_new(String(L"AddOrientationBothPlist",23),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R157::mark(){
	c_MethodInfo::mark();
...
c_R164* c_R164::m_new(){
	c_MethodInfo::m_new(String(L"GetNewName",10),2,bb_reflection__stringClass,Array<c_ClassInfo* >());
	return this;
}
void c_R164::mark(){
	c_MethodInfo::mark();
...
c_R171* c_R171::m_new(){
	c_MethodInfo::m_new(String(L"AddOrientationPortrait",22),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R171::mark(){
	c_MethodInfo::mark();
...
c_R172* c_R172::m_new(){
	c_MethodInfo::m_new(String(L"AddLibZ",7),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R172::mark(){
	c_MethodInfo::mark();
...
c_R173* c_R173::m_new(){
	c_MethodInfo::m_new(String(L"AddLibSqlite",12),2,0,Array<c_ClassInfo* >());
	return this;
}
void c_R173::mark(){
	c_MethodInfo::mark();
